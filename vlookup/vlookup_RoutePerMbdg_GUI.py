...
class vlookupMem_RoutrPerMbdg_Gui:
    def __init__(self,rootframe, fileName):
        ...
        self.Mem_RouteMBDG_frame.grid(row=3,column=0,padx=10,pady=10)


        #------------------------First Sheet Gui-----------------------# 
        self.Mem_RouteMBDG_frame_sheet1 = LabelFrame(self.Mem_RouteMBDG_frame,text="First Sheet (As a Lookup Table)",labelanchor="n")
        ...
        self.sheet1_lkupTbl_Col = Label(self.Mem_RouteMBDG_frame_sheet1,text="Vlookup Layer\nName Col").grid(row=0,column=1,padx=5,pady=5,sticky="n")
        self.sheet1_lkupTbl_Col_Entry = Entry(self.Mem_RouteMBDG_frame_sheet1,borderwidth=3,width=6,fg="black",background="white")
        self.sheet1_lkupTbl_Col_Entry.grid(row=1,column=1,padx=2,pady=2)

        #------------------------Second Sheet Gui-----------------------# 
        self.Mem_RouteMBDG_sheet2 = LabelFrame(self.Mem_RouteMBDG_frame,text="Second Sheet (As a Lookup value)",labelanchor="n")
        ...
        self.sheet2_Mem_RouteMBDG_col_label = Label(self.Mem_RouteMBDG_sheet2,text="Vlookup Route\nLayer Value Col").grid(row=0,column=1,sticky="n")
        self.sheet2_vlookup_Mem_RouteMBDG_col_entry = Entry(self.Mem_RouteMBDG_sheet2,border=3,width=6,fg="black",background="white")
        ...
        self.sheet2_Mem_RouteMBDG_result_insert_col_Entry = Entry(self.Mem_RouteMBDG_sheet2,border=3,width=6,fg="black",background="white")
        self.sheet2_Mem_RouteMBDG_result_insert_col_Entry.grid(row=1,column=2,padx=3)

        # Layer Name Header input entry
        self.sheet2_Mem_RouteMBDG_header_label = Label(self.Mem_RouteMBDG_sheet2,text="Header").grid(row=0,column=3,padx=3,sticky="n")
        self.sheet2_Mem_RouteMBDG_header_entry = Entry(self.Mem_RouteMBDG_sheet2,border=5,width=10,fg="black",background="white")
        self.sheet2_Mem_RouteMBDG_header_entry.grid(row=1,column=3,padx=3)
